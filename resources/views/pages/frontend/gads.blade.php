...
<head>
  ...
  <script>(function (w, d, s, l, i) {
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-WTB5CM4T');
  </script>
...
═══════════════════════════════════════════════════════ */
    ...
    .mc-ph {
      top: 14px;
      right: 10px;
      animation: floatB 5.5s ease-in-out 0.4s infinite;
    }

    .mc-bact {
      bottom: 14px;
      right: 10px;
      animation: floatA 6s ease-in-out 0.8s infinite;
    }

    .mc-hard {
      bottom: 14px;
      left: 10px;
      animation: floatB 5.2s ease-in-out 1.2s infinite;
    }
...
═══════════════════════════════════════════════════════ */
    ...
    .step-card:hover {
      transform: translateY(-5px);
      box-shadow: 0 20px 48px rgba(13, 27, 42, 0.09);
    }
...
═══════════════════════════════════════════════════════ */
    ...
    @keyframes waPulse {
      ...
      50% {
        box-shadow: 0 6px 42px rgba(37, 211, 102, 0.75);
      }
    }
  </style>
  ...
  <script>
    ...
    fbq('init', '2170372890377471');
    fbq('track', 'PageView');
  </script>
  <noscript>
    <img height="1" width="1" style="display:none"
      src="https://www.facebook.com/tr?id=2170372890377471&ev=PageView&noscript=1" />
  </noscript>
  <!-- End Meta Pixel Code -->
</head>
...
<body>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WTB5CM4T" height="0" width="0"
  ...
  <nav class="nav">
    <div class="nav-brand">
      <a href="{{ route('index') }}"><img src="{{ asset('assets/frontend/images/logo-white.webp') }}" alt="logo"
          style="width: 150px;" /></a>
    </div>
    <div class="nav-right">
      <a href="tel:+919344330043" class="nav-phone" style="color: white">+91 93443 30043</a>
      <a href="https://api.whatsapp.com/send/?phone=919344330043&text=Hi!+I+saw+your+ad+and+want+a+free+water+quality+test."
  ...
  <section class="hero" id="hero-section">
    ...
    <div class="hero-inner">
      ...
      <div class="hero-content">
        ...
        <div class="hero-cta">
          <a href="https://api.whatsapp.com/send/?phone=919344330043&text=Hi!+I+saw+your+YouTube+ad+and+want+a+free+water+quality+test."
  ...
  <div class="trust-bar">
    <div class="trust-item">
      ...
      <div class="trust-label">Years of Trust</div>
    </div>
    <div class="trust-item">
    ...
    <div class="trust-item">
      <div class="trust-num">22</div>
      <div class="trust-label">Point Water Test</div>
    </div>
    <div class="trust-item">
      <div class="trust-num">100%</div>
      <div class="trust-label">Free, No Strings</div>
    </div>
  </div>
    ...
    <div class="offer-form-grid">
      ...
      <section class="offer-section">
        <div class="offer-card">
          ...
          <p>Valued at ₹999 — yours absolutely free, just for watching our ad. Our expert comes to your doorstep
            anywhere in Trichy.</p>
          <div class="offer-perks">
            <div class="perk"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"
                stroke-linecap="round" stroke-linejoin="round">
                <polyline points="20 6 9 17 4 12" />
              </svg> Doorstep service</div>
            <div class="perk"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"
                stroke-linecap="round" stroke-linejoin="round">
                <polyline points="20 6 9 17 4 12" />
              </svg> Same-day results</div>
            <div class="perk"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"
                stroke-linecap="round" stroke-linejoin="round">
                <polyline points="20 6 9 17 4 12" />
              </svg> No purchase required</div>
            <div class="perk"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"
                stroke-linecap="round" stroke-linejoin="round">
                <polyline points="20 6 9 17 4 12" />
              </svg> 100% free</div>
          ...
          <div class="offer-actions">
            <a href="https://api.whatsapp.com/send/?phone=919344330043&text=Hi!+I+saw+your+YouTube+ad+and+I+want+to+book+my+free+22-point+water+quality+test."
              class="offer-btn-wa" target="_blank">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
                <path
                  d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z" />
                <path
      ...
      <section class="form-section">
        <div class="form-wrap">
          ...
          <div id="form-body">
            ...
            <div id="turnstile-widget" class="cf-turnstile" data-sitekey="{{ config('services.turnstile.site_key') }}"
          ...
          <div class="success-msg" id="success">
            ...
            <br>
            <a href="https://api.whatsapp.com/send/?phone=919344330043&text=Hi!+I+just+submitted+my+details+for+the+free+water+test."
              class="offer-btn-wa" style="display:inline-flex;margin-top:8px;" target="_blank">
  ...
  <section class="testimonials">
    ...
    <div class="testi-grid">
      <div class="testi-card">
        ...
        <div class="stars">★★★★★</div>
        <p>Water taste has completely changed. No more strange smell. The team was professional and installed everything
          within an hour.</p>
        <div class="testi-author">
          <div class="avatar">RK</div>
          <div>
            <div class="author-name">Ramesh K.</div>
            <div class="author-loc">Ariyamangalam, Trichy</div>
          </div>
        </div>
      </div>
      <div class="testi-card">
        <div class="quote-mark">"</div>
        <div class="stars">★★★★★</div>
        <p>I was skeptical about the free test but they came, tested and explained everything clearly. Installed a
          purifier the same day!</p>
        <div class="testi-author">
          <div class="avatar">SP</div>
          <div>
            <div class="author-name">Sangeetha P.</div>
            <div class="author-loc">Mannarpuram, Trichy</div>
          </div>
        </div>
      </div>
      <div class="testi-card">
        <div class="quote-mark">"</div>
        <div class="stars">★★★★★</div>
        <p>My kids had frequent stomach issues. After Safe Aqua Tech's RO, health improved significantly. Highly
          recommend to every family.</p>
        <div class="testi-author">
          <div class="avatar">MV</div>
          <div>
            <div class="author-name">Murugan V.</div>
            <div class="author-loc">Srirangam, Trichy</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- ══════════ STICKY WHATSAPP ══════════ -->
  <a href="https://api.whatsapp.com/send/?phone=919344330043&text=Hi!+I+want+to+book+my+free+water+quality+test."
